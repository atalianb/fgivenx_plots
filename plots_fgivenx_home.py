...
##
#######
m_a_new = 10.**(chains.T[2][2247:6419])
eps_new = 10.**(chains.T[3][2247:6419])
phi0_new = 10.**(chains.T[4][2247:6419])
phi1_new = 10.**(chains.T[5][2247:6419])
phi2_new = 10.**(chains.T[6][2247:6419])#3732 worked fine
