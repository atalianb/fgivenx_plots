...
data = np.loadtxt(data_path+'ESO11616.dat')
Galaxy_name = 'ESO11616'
...
params = np.array([10.**(-2.3272415E+01),
    10.**(-3.2506169E+00),
    10.**(-1.0047396E-02),
    10.**(-1.7274918E+00),
    10.**(-9.5043103E-01)])
...
##
#######
m_a_new = 10.**(chains.T[2][835:4175])
eps_new = 10.**(chains.T[3][835:4175])
phi0_new = 10.**(chains.T[4][835:4175])
phi1_new = 10.**(chains.T[5][835:4175])
phi2_new = 10.**(chains.T[6][835:4175])
