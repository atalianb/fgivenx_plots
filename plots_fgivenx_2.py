...
params = np.array([10**(-2.2088851E+01),10**(-3.9200725E+00),
                ...
                10**(-1.2797958E+00)])
path_nested = '/home/atalia/fgivenx_plots/chains/ESO1200211'
...
##
#######
m_a_new = 10.**(chains.T[2][1284:6419])
eps_new = 10.**(chains.T[3][1284:6419])
phi0_new = 10.**(chains.T[4][1284:6419])
phi1_new = 10.**(chains.T[5][1284:6419])
phi2_new = 10.**(chains.T[6][1284:6419])
